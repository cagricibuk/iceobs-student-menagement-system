...
Public Class verdigimDersler
    ...
    Private Sub SetupListView()
        ...
        ListView1.Columns.Add("ders kodu", 100, HorizontalAlignment.Left)
        ListView1.Columns.Add("ders adi", 100, HorizontalAlignment.Left)
        ...
        ListView1.Columns.Add("bölüm kodu", 100, HorizontalAlignment.Left)
    ...
    End Sub
    Private Sub verdigimDersler_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Dim komut As New SqlCommand("SELECT * FROM sunulandersler WHERE ogretmen_numara='" & login.Numara & "'", baglanti)
        baglanti.Open()
