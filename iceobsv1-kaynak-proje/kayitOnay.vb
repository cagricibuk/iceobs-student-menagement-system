...
Imports System.IO
Public Class kayitOnay

    Public Shared ogrenciId As String
    Public id As String
    ...
    End Sub
    Private Sub kayitOnay_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        DilKontrol()
        bilgiler()
        resimYukle()
        ...
        Dim komut As New SqlCommand("SELECT * FROM ogrenciler WHERE danisman_ogretmen_numara='" & login.Numara & "' AND ders_sec=1", baglanti)
        baglanti.Open()
    ...
    Private Sub ListView1_MouseDoubleClick(sender As Object, e As MouseEventArgs) Handles ListView1.MouseDoubleClick
        ogrenciId = ListView1.SelectedItems(0).Text
        MessageBox.Show(ListView1.SelectedItems(0).Text)
        kayitOnay_addon.ShowDialog()
